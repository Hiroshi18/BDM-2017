...
class ItemEnt(models.Model):
    ...
    itemIdentifier = models.CharField(max_length=1000, blank=False, null=True)
    provenanceOfTheItem = models.CharField(max_length=1000, blank=False, null=True)
    locationOfItem = models.CharField(max_length=1000, blank=False, null=True)
