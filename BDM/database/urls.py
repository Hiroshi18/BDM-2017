...
urlpatterns = (
    ...
    url(r'^search_expr_ent/$', SearchExprEntView.as_view(), name='search_expr_ent'),
    ...
    url(r'^search_manif_ent/$', SearchManifEntView.as_view(), name='search_manif_ent'),
    ...
    url(r'^search_item_ent/$', SearchItemEntView.as_view(), name='search_item_ent'),

    url(r'^list_all_ent/$', ListAllEntView.as_view(), name='list_all_ent'),
